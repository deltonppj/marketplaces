# Scrapy settings for marketplaces project
#
...
#    'marketplaces.middlewares.MarketplacesDownloaderMiddleware': 543,
# }
...
ITEM_PIPELINES = {
   'marketplaces.pipelines.AmericanasPipeline': 300,
}

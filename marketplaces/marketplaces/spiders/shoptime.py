...
class ShoptimeSpider(scrapy.Spider):
    ...
    def __init__(self, search=None, filter=None, price=None, validate_freight=False, **kwargs):
        ...
        self.query_filter = '?filter=%7B"id"%3A"loja"%2C"value"%3A"1p%7CShoptime%7Cb2w.loja"%2C"fixed"%3Afalse%7D&sortBy=relevance'
        ...
        self.url = f'https://www.shoptime.com.br/busca/{self.keyword}{self.query_filter}{self.query_offset.format(self.offset)}'
        ...
        self.limit_page = '//*[contains(text(), "Nenhum resultado encontrado para ")]'
    ...
    def parse(self, response, **kwargs):
        ...
        self.offset += 24
        url = f'https://www.shoptime.com.br/busca/{self.keyword}{self.query_filter}{self.query_offset.format(self.offset)}'

...
class SubmarinoSpider(scrapy.Spider):
    ...
    def __init__(self, search=None, filter=None, price=None, validate_freight=False, **kwargs):
        ...
        self.query_filter = '?filter=%7B%22id%22%3A%22loja%22%2C%22value%22%3A%221p%7CSubmarino%7Cb2w.loja%22%2C%22fixed%22%3Afalse%7D&sortBy=relevance'
        ...
        self.url = f'https://www.submarino.com.br/busca/{self.keyword}{self.query_filter}{self.query_offset.format(self.offset)}'
        ...
        self.limit_page = '//*[contains(text(), "Não encontramos nenhum resultado ")]'
    ...
    def parse(self, response, **kwargs):
        ...
        self.offset += 24
        url = f'https://www.submarino.com.br/busca/{self.keyword}{self.query_filter}{self.query_offset.format(self.offset)}'
